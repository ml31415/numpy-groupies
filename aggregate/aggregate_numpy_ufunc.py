...
def _all(group_idx, a, n, fill_value, dtype=None):
    check_boolean(fill_value, name="fill_value")
    ret = np.full(n, fill_value, dtype=bool)
    if not fill_value:
