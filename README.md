...
The benchmarking results are given in ms for an i7-7560U running at 2.40GHz with Python 3.14, NumPy 2.5, Numba 0.67 and Pandas 3.0, taking the minimum over 3 runs:

| function | ufunc  | numpy   | numba  | pandas  |
|-----------|--------|---------|--------|---------|
| sum        |   1.311 |   1.157 |   0.754 |  13.567 |
| prod       |   1.342 |   1.287 |   0.673 |  12.985 |
| min        |   2.574 |   2.611 |   0.804 |  12.725 |
| max        |   2.601 |   2.642 |   0.795 |  12.790 |
| len        |   1.475 |   0.997 |   0.542 |  11.971 |
| all        |  39.363 |   2.543 |   0.864 |  13.436 |
| any        |  37.838 |   3.078 |   0.801 |  13.312 |
| anynan     |   6.178 |   1.407 |   0.741 |  12.702 |
| allnan     |   8.835 |   3.412 |   0.744 |  12.957 |
| mean       |    ---- |   1.820 |   0.710 |  13.916 |
| median     |    ---- |  52.599 |  10.600 |  24.571 |
| trapezoid  |    ---- |   4.321 |   0.989 |    ---- |
| std        |    ---- |   4.119 |   0.939 |  14.521 |
| var        |    ---- |   4.203 |   0.995 |  14.842 |
| first      |    ---- |   1.894 |   0.630 |  13.323 |
| last       |    ---- |   1.455 |   0.604 |  13.167 |
| argmax     |    ---- |   3.995 |   0.981 |  12.518 |
| argmin     |    ---- |   6.339 |   0.965 |  12.630 |
| nansum     |    ---- |   4.911 |   1.921 |  19.577 |
| nanprod    |    ---- |   4.991 |   1.872 |  18.598 |
| nanmin     |    ---- |   6.168 |   1.738 |  18.242 |
| nanmax     |    ---- |   6.097 |   1.721 |  18.263 |
| nanlen     |    ---- |   3.074 |   1.589 |  18.301 |
| nanall     |    ---- |   6.146 |   1.784 |  19.439 |
| nanany     |    ---- |   6.735 |   1.758 |  18.753 |
| nanmean    |    ---- |   5.500 |   1.934 |  20.508 |
| nanmedian  |    ---- |  55.977 |   9.888 |  26.548 |
| nantrapezoid|    ---- |   7.744 |   2.088 |    ---- |
| nanvar     |    ---- |   7.529 |   1.893 |  20.712 |
| nanstd     |    ---- |   7.545 |   1.823 |  20.979 |
| nanfirst   |    ---- |   5.494 |   1.547 |  19.477 |
| nanlast    |    ---- |   5.347 |   1.594 |  18.512 |
| nanargmin  |    ---- |   8.710 |   2.155 |  14.224 |
| nanargmax  |    ---- |   5.978 |   2.206 |  14.108 |
| cumsum     |    ---- |  53.219 |   1.194 |   8.733 |
| cumprod    |    ---- |    ---- |   1.263 |  12.977 |
| cummax     |    ---- |    ---- |   1.255 |  13.432 |
| cummin     |    ---- |    ---- |   1.224 |  13.559 |
| arbitrary  |    ---- | 150.488 |  52.901 | 121.052 |
| sort       |    ---- | 144.673 |    ---- |    ---- |
